...
* **Hardhat Config:** Network config for Lisk Sepolia (4242) and Lisk Mainnet (1135)
...
* **ABI Management:** Export ABIs from Hardhat artifacts and copy to backend `config/abis/`
